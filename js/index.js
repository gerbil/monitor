...
function getData_all() {
    ...
    for (var i = 0; i < length; i++) {
        if (typeof (data_hgd0b1_slice[i]) == 'undefined') {
            data_hgd0b1_slice[i] = ["0", "0"]
        }
        if (typeof (data_all[i][1]) == 'undefined') {
            data_all[i][1] = "1"
        }
    ...
    for (var i = 0; i < length; i++) {
        if (typeof (data_hgd0b2_slice[i]) == 'undefined') {
            data_hgd0b2_slice[i] = ["0", "0"]
        }
        if (typeof (data_all[i][1]) == 'undefined') {
            data_all[i][1] = "1"
        }
    ...
    for (var i = 0; i < length; i++) {
        if (typeof (data_kstb1_slice[i]) == 'undefined') {
            data_kstb1_slice[i] = ["0", "0"]
        }
        if (typeof (data_all[i][1]) == 'undefined') {
            data_all[i][1] = "1"
        }
