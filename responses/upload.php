...
if (isset($_FILES['file'])) {
    ...
    if (empty($errors)) {
        ...
        $servers['kstb2']['user'] = 'provkst02';
        $servers['kstb2']['password'] = 'e2uPxreNbchUO80J';
        $servers['kstb2']['url'] = 'obelix.corp.tele2.com/PROVDB';

        $servers['kstb3']['user'] = 'provkst03';
        $servers['kstb3']['password'] = 'x7du8shQcMbFpmm1';
        $servers['kstb3']['url'] = 'obelix.corp.tele2.com/PROVDB';

        $servers['hgd-prov-b2']['user'] = 'provhgd02';
        $servers['hgd-prov-b2']['password'] = 'fQVEQLPjy8InVexu';
        $servers['hgd-prov-b2']['url'] = 'obelix.corp.tele2.com/PROVDB';

        $servers['hgd-prov-b3']['user'] = 'provhgd03';
        $servers['hgd-prov-b3']['password'] = 'RFMkcPynUUktLGcv';
        $servers['hgd-prov-b3']['url'] = 'obelix.corp.tele2.com/PROVDB';
        ...
        for ($c = 0; $c < $sizeOfErrors; $c++) {
            echo "<li class='error'>" . $errors[$c] . "</li>";
        }
    }
