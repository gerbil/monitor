...
<?php get_header(); ?>
    ...
    <div class="row-fluid">
        <div class="span6 ">
            <div class="box color_1_4 title_big fill">
                <div class="title">
                    <div class="row-fluid">
                        <div class="span12">
                            <h4><span>KSTB2</span></h4>
                        </div>
                    </div>
                </div>
                <div class="content">
        ...
        <div class="span6 ">
            <div class="box color_1_2 title_big fill">
                <div class="title">
                    <div class="row-fluid">
                        <div class="span12">
                            <h4><span>HGDB2</span></h4>
                        </div>
                    </div>
                </div>
                <div class="content">
                    <div class="row-fluid">
                        <div id="provhgd02"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="span6 ">
            <div class="box color_12 title_big fill">
                <div class="title">
                    <div class="row-fluid">
                        <div class="span12">
                            <h4><span>HGDB3</span></h4>
                        </div>
                    </div>
                </div>
                <div class="content">
                    <div class="row-fluid">
                        <div id="provhgd03"></div>
                    </div>
                </div>
            </div>
        </div>
